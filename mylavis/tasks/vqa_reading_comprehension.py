...
from mylavis.common.dist_utils import get_rank, get_world_size, is_main_process
from mylavis.common.registry import registry
from mylavis.common.vqa_tools.vqa_eval import VQAEval as VQATool
from mylavis.tasks.vqa import VQATask
