...
from mylavis.datasets.datasets.coco_caption_datasets import (
    COCOCapDataset,
    COCOCapEvalDataset,
    NoCapsEvalDataset,
)
...
from mylavis.datasets.datasets.video_caption_datasets import (
    VideoCaptionDataset,
    VideoCaptionEvalDataset,
)
# v0
from mylavis.datasets.datasets.audata_caption_datasets import (
    AUDATACapDataset,
    AUDATACapEvalDataset,
)

# v0
@registry.register_builder("audata_caption")
class AUDATACapBuilder(BaseDatasetBuilder):
    train_dataset_cls = AUDATACapDataset
    eval_dataset_cls = AUDATACapEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/audata/defaults_cap.yaml",
    }
