...
from mylavis.datasets.datasets.image_text_pair_datasets import ImageTextPairDataset
from mylavis.datasets.datasets.laion_dataset import LaionDataset


@registry.register_builder("audata_pretrain")
class AUDATAPretrainBuilder(BaseDatasetBuilder):
    train_dataset_cls = ImageTextPairDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/audata_pre/defaults_cap.yaml"
    }
