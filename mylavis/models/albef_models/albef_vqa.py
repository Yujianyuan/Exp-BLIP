...
from mylavis.common.utils import get_abs_path, is_url
from mylavis.models.albef_models import AlbefBase
from mylavis.models.albef_models.albef_outputs import AlbefIntermediateOutput, AlbefOutput
from mylavis.models.base_model import MomentumDistilationMixin, tile
from mylavis.models.med import BertConfig, BertLMHeadModel, XBertEncoder
from mylavis.models.vit import VisionTransformerEncoder, interpolate_pos_embed
from mylavis.common.dist_utils import download_cached_file
...
class AlbefVQA(AlbefBase, MomentumDistilationMixin):
    ...
    def forward(self, samples):
        ...
        Returns:
            ...
            see mylavis/models/albef_models/albef_outputs.py for more details.
    ...
    def predict_answers(self, samples, answer_list, num_ans_candidates=128, **kwargs):
        ...
        Examples:
            ...
            >>> from mylavis.models import load_model_and_preprocess
