...
from mylavis.models.albef_models.albef_outputs import (
    AlbefIntermediateOutput,
    AlbefOutput,
    AlbefSimilarity,
)
from mylavis.models.base_model import MomentumDistilationMixin, SharedQueueMixin
from mylavis.models.med import BertForMaskedLM
...
class AlbefPretrain(AlbefBase, MomentumDistilationMixin, SharedQueueMixin):
    ...
    def forward(self, samples):
        ...
        Returns:
            BlipOutput: A BlipOutput object containing loss and intermediate output. See ``mylavis.models.blip_models.blip_outputs.BlipOutput`` for more details.
