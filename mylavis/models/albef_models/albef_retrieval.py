...
from mylavis.models.albef_models import AlbefBase, compute_sim_matrix
...
class AlbefRetrieval(AlbefBase, MomentumDistilationMixin, SharedQueueMixin):
    ...
    def forward(self, samples):
        ...
        Returns:
            BlipOutput: A BlipOutput object. See ``mylavis.models.blip_models.blip_outputs.BlipOutput`` for more details.
