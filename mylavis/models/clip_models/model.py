...
from mylavis.common.utils import get_abs_path
from mylavis.models.base_model import BaseModel
from mylavis.models.clip_models.clip_outputs import ClipOutput, ClipOutputFeatures
from mylavis.models.clip_models.timm_model import TimmModel
from mylavis.models.clip_models.transform import image_transform
from mylavis.models.clip_models.utils import freeze_batch_norm_2d
from mylavis.tasks.multimodal_classification import MultimodalClassificationTask
...
class CLIP(BaseModel):
    ...
    def loss(self):
        if self._loss is None:
            from mylavis.models.clip_models.loss import ClipLoss
    ...
    def zero_shot_predict(self, image_path, categories):
        ...
        from mylavis.processors.clip_processors import ClipImageEvalProcessor
