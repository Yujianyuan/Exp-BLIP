...
from mylavis.models.blip2_models.modeling_t5 import T5Config, T5ForConditionalGeneration
import os
...
class Blip2T5(Blip2Base):
    ...
    def __init__(
        ...
        self.t5_tokenizer = T5TokenizerFast.from_pretrained(cache_path)
        t5_config = T5Config.from_pretrained(cache_path)
        t5_config.dense_act_fn = "gelu"
        self.t5_model = T5ForConditionalGeneration.from_pretrained(
            cache_path, config=t5_config
        )
